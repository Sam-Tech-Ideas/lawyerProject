  ...
  return (
    <div>
      <div class="container px-5 py-6 mx-auto  flex">
        <div class=" bg-[#d09a58] rounded-lg p-8 flex flex-col md:mr-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
          ...
          {/* <div className=' bg-white w-10 mb-2 flex text-center justify-center items-center '>
            <hr className="" />
          </div> */}
